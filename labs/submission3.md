...
```sh
ssh-keygen -t ed25519 -C "student@devsecops.lab" -f ~/.ssh/lab3_signing_key
```

Output:
```
Generating public/private ed25519 key pair.
Your identification has been saved in /tmp/lab3_signing_key
Your public key has been saved in /tmp/lab3_signing_key.pub
The key fingerprint is:
SHA256:eSZTRBGSsCM7FwcJNJqYRWzDHwMQnPyaH2KWH2LaRPY student@devsecops.lab
```

Public key generated:
```
ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOZHO68FDJ9wDY3bhytcY2c0SyW/x+oCVfG3COEsEqZM student@devsecops.lab
```
